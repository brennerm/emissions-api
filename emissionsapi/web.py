...
def get_data(session, country=None, geoframe=None, begin=None, end=None):
    ...
    """
    def create_rectangle(lo1, lat1, lo2, lat2):
        """Create a WKTElement Rectangle from 2 points"""
        return geoalchemy2.elements.WKTElement(
            f'POLYGON(({lo1} {lat1}, {lo2} {lat1},'
            f' {lo2} {lat2}, {lo1} {lat2}, {lo1} {lat1}))')
    ...
    # parse parameter country
        ...
        rectangle = create_rectangle(*country_bounding_boxes[country][1])
